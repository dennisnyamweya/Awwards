...
urlpatterns = [
    ...
    path('projects/profile_update/<int:pk>',views.ProfileUpdateView.as_view(),name="update"),
    path('projects/profile_delete/<int:pk>',views.ProfileDeleteView.as_view(),name="delete"),
